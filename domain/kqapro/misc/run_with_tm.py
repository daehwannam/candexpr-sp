...
def validate(
    ...
    for batch in config.xtqdm(data_loader, **xtqdm_kwargs):
        ...
        from dhnamlib.pylib.time import TimeMeasure  # debug
        tm = TimeMeasure()                           # debug
        tm.check()                                   # debug
        ...
        total_decoding_time += tm.elapse()             # debug
    ...
    print('Time x -> a :', total_decoding_time)  # debug
