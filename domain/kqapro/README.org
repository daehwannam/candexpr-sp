...
#+begin_src sh
python -m run --domain kqapro --config config.kqapro.train_default
#+end_src
...
TEST_CONFIG='config.kqapro.test_on_val_set'  # or 'config.kqapro.test_on_test_set'
MODEL_PATH='path/to/model'
COMMON_TEST_CMD="python -m run --domain kqapro --config config.kqapro.$TEST_CONFIG --model-path $MODEL_PATH"
