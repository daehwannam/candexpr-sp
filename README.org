...
** Making a prediction file on the test set
#+begin_src sh
MODEL_LEARNING_DIR_PATH='path/to/model/learning/dir'
...
The evaluation code is slighted modified from [[https://github.com/shijx12/KQAPro_Baselines/blob/7cea2738fd095a2c17594d492923ee80a212ac0f/evaluate.py][KQAPro_Baselines]].
The evaluation code requires a prediction file.
