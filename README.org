...
#+begin_src sh
COMMON_WS_MODEL_LEARNING_DIR_PATH=./model-instance/weakly-supervised-model
#+end_src
...
*** Testing on the validation set with the default checkpoint path
#+begin_src sh
...
MODEL_LEARNING_DIR_PATH='path/to/model/learning/dir'
# e.g. MODEL_LEARNING_DIR_PATH=model-instance/2023-07-15_10:10:24_916400
MODEL_DIR_NAME='full-constraints:best'
# Options for MODEL_DIR_NAME: best, common:best, full-constraints:best, no-arg-candidate:best, no-ac-no-dut:best, no-constrained-decoding:best
...
*** Testing on the test set with the default checkpoint path
#+begin_src sh
MODEL_LEARNING_DIR_PATH='path/to/model/learning/dir'
# e.g. MODEL_LEARNING_DIR_PATH=model-instance/2023-07-15_10:10:24_916400
...
*** Testing with specifying checkpoint path and test directory path
#+begin_src sh
